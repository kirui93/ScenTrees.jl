...
In these tutorials, we assume that the reader is quite familiar with the theory and explanation in the paper <a href="https://doi.org/10.1007/s10589-015-9758-0" title="Dynamic Generation of Scenario Trees">Georg Ch. Pflug and Alois Pichler(2015)</a>.
